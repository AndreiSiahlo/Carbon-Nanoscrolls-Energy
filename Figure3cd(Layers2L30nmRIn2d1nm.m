...
(*NanoscrollNamep=StringJoin["Nanoscroll",ToString[NoLp],"L",ToString[L1p/nm],"nm"];*)
...
(*AA=0.1nm;PhiIn:=\[CurlyPhi]In;PhiOut:=\[CurlyPhi]Out;*)
(*Print["-----------------------------------------------------------"];*)
(**)
...
(*       ArcSinh[PhiOutv]));*)
(*Print["  fSpiraleLen[",NoLp,", \[CurlyPhi]In, \[CurlyPhi]Out, h]=",fSpiraleLen[NoLp,PhiIn,PhiOut,h],"."];*)
...
(*Print[" fElast[\[CurlyPhi]In,\[CurlyPhi]Out] = ", fElast[PhiIn, PhiOut],"."];*)
...
(*Print[" The function fPhiOutvsPhiInLh[",NoLp,",",PhiIn,",L,h]=",fPhiOutvsPhiInLh[NoLp,PhiIn,L,h]," is a*)
...
(*Print[" The inverse function fPhiInvsPhiOutLh[",NoLp,",\[CurlyPhi]Out, L, h]]=", *)
...
(*fSpirale1UnderSpirale1Length[NoLv_,PhiIn1v_ ,PhiOut1v_,hv_]:=fSpiraleLen[NoLv,PhiIn1v ,PhiOut1v-2Pi,hv];*)
(*fSpirale1OverSpirale1Length[NoLv_,PhiIn1v_ ,PhiOut1v_,hv_]:=fSpiraleLen[NoLv,PhiIn1v+2Pi ,PhiOut1v,hv];*)
(**)
(*fSpirale1UnderSpirale2Length[NoLv_,PhiIn1v_ ,PhiOut1v_,hv_,dPhi12v_]:=fSpiraleLen[NoLv,PhiIn1v, PhiOut1v -2 Pi/NoLv,hv]; *)
(*fSpirale1OverSpirale2Length[NoLv_,PhiIn1v_ ,PhiOut1v_,hv_,dPhi12v_]:= fSpiraleLen[NoLv,PhiIn1v + 2Pi/NoLv +dPhi12v,PhiOut1v,hv];*)
(*fSpirale2UnderSpirale1Length[NoLv_,PhiIn1v_ ,PhiOut1v_,hv_,dPhi12v_]:=fSpiraleLen[NoLv,PhiIn1v, PhiOut1v -2 Pi/NoLv,hv]; *)
(*fSpirale2OverSpirale1Length[NoLv_,PhiIn1v_ ,PhiOut1v_,hv_,dPhi12v_]:=fSpiraleLen[NoLv,PhiIn1v -dPhi12v+ 2Pi/NoLv,PhiOut1v - dPhi12v,hv];*)
(**)
(*Print["  These functiona are not required, dut could be helpful),"];*)
(**)
(*If[NoLp==1,*)
(*Print["fSpirale1UnderSpirale1Length[1,PhiIn1v ,PhiOut1v,hv]="];*)
(*Print["  =fSpiraleLen[NoLv,PhiIn1v ,PhiOut1v-2Pi,hv]=",fSpiraleLen[NoLv,PhiIn1v ,PhiOut1v-2Pi,hv],";"];*)
(*Print["  fSpirale1UnderSpirale1Length[NoLp,PhiIn1p ,PhiOut1p,hp]=fSpirale1UnderSpirale1Length[",NoLp,",",PhiIn1p/(2Pi),"(2Pi),",PhiOut1p/(2Pi),"(2Pi),",hp/nm,"nm] ="];*)
(*Print["  =",fSpirale1UnderSpirale1Length[NoLp,PhiIn1p ,PhiOut1p,hp]/nm,"nm."];*)
(**)
(*Print["fSpirale1OverSpirale1Length[1,PhiIn1v ,PhiOut1v,hv]="];*)
(*Print["  =fSpiraleLen[NoLv,PhiIn1v+2Pi ,PhiOut1v,hv]=",fSpiraleLen[NoLv,PhiIn1v+2Pi ,PhiOut1v,hv],";"];*)
(*Print["  fSpirale1OverSpirale1Length[NoLp,PhiIn1p ,PhiOut1p,hp]=fSpirale1OverSpirale1Length[",NoLp,",",PhiIn1p/(2Pi),"(2Pi),",PhiOut1p/(2Pi),"(2Pi),",hp/nm,"nm] ="];*)
(*Print["  =",fSpirale1OverSpirale1Length[NoLp,PhiIn1p ,PhiOut1p,hp]/nm,"nm."];*)
(*];*)
(**)
(*If[NoLp==2,*)
(*Print["  fSpirale1UnderSpirale2Length[1,PhiIn1v ,PhiOut1v,hv,dPhi12v]="];*)
(*Print["  fSpiraleLen[NoLv,PhiIn1v, PhiOut1v -2 Pi/NoLv,hv]=",fSpirale1UnderSpirale2Length[1,PhiIn1v ,PhiOut1v,hv,dPhi12v],";"];*)
(*Print["fSpirale1UnderSpirale2Length[NoLp,PhiIn1p ,PhiOut1p,hp,dPhi12p]=fSpirale1UnderSpirale2Length[",NoLp,",",PhiIn1p/(2Pi),"(2Pi),",PhiOut1p/(2Pi),"(2Pi),",hp/nm,"nm,",dPhi12p/(2Pi),"(2Pi)] ="];*)
(*Print["  =",fSpirale1UnderSpirale2Length[NoLp,PhiIn1p ,PhiOut1p,hp,dPhi12p]/nm,"nm."];*)
(*Print["  fSpirale1OverSpirale2Length[1,PhiIn1v ,PhiOut1v,hv,dPhi12v]="];*)
(*Print["  =fSpiraleLen[NoLv,PhiIn1v+Pi ,PhiOut1v,hv]=",fSpiraleLen[NoLv,PhiIn1v+Pi ,PhiOut1v,hv],";"];*)
(*Print["fSpirale1OverSpirale2Length[NoLp,PhiIn1p ,PhiOut1p,hp]=fSpirale1OverSpirale1Length[",NoLp,",",PhiIn1p/(2Pi),"(2Pi),",PhiOut1p/(2Pi),"(2Pi),",hp/nm,"nm] ="];*)
(*Print["  =",fSpirale1OverSpirale2Length[NoLp,PhiIn1p ,PhiOut1p,hp,dPhi12p]/nm,"nm."];*)
(*Print[""];*)
(*Print["  fSpirale2UnderSpirale1Length[1,PhiIn1v ,PhiOut1v,hv]="];*)
(*Print["  fSpiraleLen[NoLv,PhiIn1v, PhiOut1v -2 Pi/NoLv,hv]=",fSpirale1UnderSpirale2Length[1,PhiIn1v ,PhiOut1v,hv,dPhi12v],";"];*)
(*Print["fSpirale2UnderSpirale1Length[NoLp,PhiIn1p ,PhiOut1p,hp,dPhi12p]=fSpirale2UnderSpirale1Length[",NoLp,",",PhiIn1p/(2Pi),"(2Pi),",PhiOut1p/(2Pi),"(2Pi),",hp/nm,"nm,",dPhi12p/(2Pi),"(2Pi)] ="];*)
(*Print["  =",fSpirale1UnderSpirale2Length[NoLp,PhiIn1p ,PhiOut1p,hp,dPhi12p]/nm,"nm."];*)
(*Print["  fSpirale1OverSpirale2Length[1,PhiIn1v ,PhiOut1v,hv]="];*)
(*Print["  =fSpiraleLen[NoLv,PhiIn1v+Pi ,PhiOut1v,hv]=",fSpiraleLen[NoLv,PhiIn1v+Pi ,PhiOut1v,hv],";"];*)
(*Print["fSpirale1OverSpirale2Length[NoLp,PhiIn1p ,PhiOut1p,hp]=fSpirale1OverSpirale2Length[",NoLp,",",PhiIn1p/(2Pi),"(2Pi),",PhiOut1p/(2Pi),"(2Pi),",hp/nm,"nm] ="];*)
(*Print["  =",fSpirale1OverSpirale2Length[NoLp,PhiIn1p ,PhiOut1p,hp,dPhi12p]/nm,"nm."];*)
(*];*)
(**)
(*Print[" II.2.4. The function fRIn1Sharp[NoLv,L1v,hv]"]*)
(*fRIn1Sharp[NoLv_,L1v_,hv_]:=(L1v/(2Pi)-(NoLv hv/2));*)
...
(*Print["fRIn1Sharp[",NoLp,", ",L1p/nm,"nm, ",hp/nm,"nm] = ",fRIn1Sharp[NoLp,L1p,hp]/nm,"nm"];*)
(*Print["-----------------------------------------------------------"];*)
(**)
...
(*Print[" \[CurlyPhi]In1=", PhiIn1p/(2 Pi), "(2Pi),\[CapitalPsi]Out1=", PhiOut1p/(2 Pi),"(2Pi)."];*)
(*fPhiIn2[NoLv_, RIn1v_, hv_, dPhi12v_]:= *)
(*  fPhiIn1[NoLv, RIn1v, hv] + dPhi12v;*)
(*PhiIn2dPhi12p = *)
(*  fPhiIn2[NoLp, RIn1p, hp,0];(*www orig 2022.10*)*)
(*PhiIn2dPhi12p = *)
(*  fPhiIn2[NoLp, RIn1p, hp,dPhi12p];(* for dPhi12p!=0, checked 2022.10*)*)
(*PhiIn2dPhi12Pip = *)
(*  fPhiIn2[NoLp, RIn1p, hp,Pi];*)
(*fPhiOut2[NoLv_, L1v_, RIn1v_, hv_, dPhi12v_]:= *)
(*  fPhiOutvsPhiInLh[NoLv,fPhiIn2[NoLv, RIn1v, hv, dPhi12v], L1v, hv];*)
(*PhiOut2dPhi12p = *)
(*  fPhiOut2[NoLp, L1p, RIn1p, hp,dPhi12p];*)
(*If[NoLp==2,Print["  \[CurlyPhi]In2=", PhiIn2dPhi12p/(2 Pi), "(2Pi),\[CurlyPhi]Out2=", PhiOut2dPhi12p/(2 Pi),"(2Pi)"];*)
(*PhiOut2dPhi12Pip = *)
(*  fPhiOut2[NoLp, L1p, RIn1p, hp,Pi];*)
(*Print[" for d\[CurlyPhi]12=Pi: PhiIn2=", PhiIn2dPhi12Pip/(2 Pi), "(2Pi),\[CurlyPhi]Out2=", PhiOut2dPhi12Pip/(2 Pi),"(2Pi)"];];*)
...
(*Spirale2Plot = PolarPlot[(Phiv - Pi) NoLp hp/(2 Pi)/nm, {Phiv,PhiIn2dPhi12p + Pi, PhiOut2dPhi12p + Pi}, *)
(*    PlotRange -> {{-1.1 ROut1p/nm, 1.1 ROut1p/nm}, {-1.1 ROut1p/nm, *)
(*       1.1 ROut1p/nm}}, PlotStyle -> {Blue, Thin}, Axes -> None];*)
(*Spirale2dPhi12PiPlot = PolarPlot[(Phiv - Pi) NoLp hp/(2 Pi)/nm, {Phiv,PhiIn2dPhi12p + Pi, PhiOut2dPhi12Pip + Pi}, *)
(*    PlotRange -> {{-1.1 ROut1p/nm, 1.1 ROut1p/nm}, {-1.1 ROut1p/nm, *)
(*       1.1 ROut1p/nm}}, PlotStyle -> {Blue, Thin}, Axes -> None];*)
...
(*     PlotRange -> {{-1.1 ROut1p/nm, 1.1 ROut1p/nm}, {-1.1 ROut1p/nm, *)
(*        1.1 ROut1p/nm}}, PlotStyle -> {Red, Thick}, Axes -> None], {}];*)
(*  Print[" {Spirale,Spirale1UnderSpirale1},{Spirale1,Spirale1OverSpirale1}:"];*)
...
(*      PhiIn2dPhi12p + Pi, PhiOut1p}, PlotStyle -> {Blue, Thick}, *)
(*     PlotRange -> {{-1.1 ROut1p/nm, 1.1 ROut1p/nm}, {-1.1 ROut1p/nm, *)
(*        1.1 ROut1p/nm}}], {}];*)
...
(*   Show[Spirale1Plot, Spirale2Plot, Spirale1UnderSpirale2dPhi120Plot, *)
(*    Spirale2UnderSpirale1dPhi120Plot], *)
(*   Show[Spirale1Plot, Spirale2Plot, Spirale1OverSpirale2dPhi120Plot, *)
(*    Spirale2OverSpirale1dPhi120Plot]];*)
...
(*fEVdWLayer1Overlap[NoLv_,Lwv_,L1v_, RIn1v_, hv_, aCCv_, epsVdWv_] :=Module[*)
(*{EVdWv,*)
...
(* },*)
(*Spirale1OverSpirale1Length= fSpiraleLen[NoLv,PhiIn1v + 2 Pi, PhiOut1v,hv];*)
(*Spirale1UnderSpirale1Length= fSpiraleLen[NoLv,PhiIn1v , PhiOut1v-2Pi,hv];*)
(*"Note: Spirale1OverSpirale1Length>Spirale1UnderSpirale1Length";*)
(*EVdW1Un1v = -epsVdWv Lwv/(2 fSa[aCCv]) Spirale1UnderSpirale1Length;*)
...
(*fEVdWLayersOverlap[NoLv_,Lwv_,L1v_, RIn1v_, hv_, aCCv_, epsVdWv_, dPhi12v_] :=Module[*)
(*{EVdW,*)
...
(*},*)
(*If[NoLv== 1,*)
(*If[PhiIn1 < PhiOut1 - 2 Pi,Spirale1UnderSpirale1Length=fSpiraleLen[NoLv,PhiIn1,PhiOut1 - 2 Pi,hv];];*)
(*If[PhiIn1 + 2 Pi < PhiOut1,Spirale1OverSpirale1Length= fSpiraleLen[NoLv,PhiIn1 + 2 Pi, PhiOut1,hv];];*)
(*EVdW1Un1 = -epsVdWv Lwv/(2 fSa[aCCv]) Spirale1UnderSpirale1Length;*)
(*EVdW1Ov1 = -epsVdWv Lwv/(2 fSa[aCCv]) Spirale1OverSpirale1Length;*)
(*EVdW=(EVdW1Un1 + EVdW1Ov1);*)
(*ReturnEnergiesv={EVdW,EVdW1Un1, EVdW1Ov1};*)
(*];*)
(*If[NoLv== 2,*)
(*    If[PhiIn1 < PhiOut2 - Pi,Spirale1UnderSpirale2Length = fSpiraleLen[NoLv,PhiIn1, PhiOut2 - Pi,hv];];*)
(*    If[PhiIn1 + Pi +dPhi12v<PhiOut1,Spirale1OverSpirale2Length = fSpiraleLen[NoLv,PhiIn1 + Pi +dPhi12v,PhiOut1,hv];];*)
(*    If[PhiIn1 + dPhi12v < PhiOut1 - Pi,Spirale2UnderSpirale1Length = fSpiraleLen[NoLv,PhiIn1 + dPhi12v,PhiOut1 - Pi,hv];];*)
(*    If[PhiIn1 - dPhi12v + Pi < PhiOut2 - dPhi12v,Spirale2OverSpirale1Length=fSpiraleLen[NoLv,PhiIn1 -dPhi12v+ Pi,PhiOut2 - dPhi12v,hv];];*)
(*EVdW1Un2 = -epsVdWv Lwv/(2 fSa[aCCv]) Spirale1UnderSpirale2Length;*)
(*     EVdW1Ov2 = -epsVdWv Lwv/(2 fSa[aCCv]) Spirale1OverSpirale2Length;*)
(*     EVdW2Un1 = -epsVdWv Lwv/(2 fSa[aCCv]) Spirale2UnderSpirale1Length;*)
(*     EVdW2Ov1 = -epsVdWv Lwv/(2 fSa[aCCv]) Spirale2OverSpirale1Length;*)
...
(**)
(*EVdWdPhi12eq0allp = *)
(*  fEVdWLayersOverlap[NoL2,Lwp,L1p,RIn1p,hp,aCCp,epsVdWp,dPhi12eq0];*)
(*EVdWvardPhi12allp = *)
(*  fEVdWLayersOverlap[NoLp,Lwp,L1p, RIn1p, hp, aCCp, epsVdWp, dPhi12p];*)
(*If[NoLp==1,*)
(*Print[" EVdWvardPhi12allp[[iEVdW]]=",EVdWvardPhi12allp[[iEVdW]]/(eV/atom), "eV/atom"];*)
(*Print["( EVdWvardPhi12allp[[iEVdW1Un1]]=",EVdWvardPhi12allp[[iEVdW1Un1]]/(eV/atom), "eV/atom"];*)
(*  Print["  EVdWvardPhi12allp[[iEVdW1Ov1]]=",EVdWvardPhi12allp[[iEVdW1Ov1]]/(eV/atom), "eV/atom  )"];*)
(*];*)
(*If[NoLp==2,*)
...
(*  EVdWdPhi12eqPiallp = *)
(*   fEVdWLayersOverlap[NoLp,Lwp,L1p,RIn1p, hp, aCCp, epsVdWp, dPhi12eqPi];*)
...
(*fEnergyFlatPlanes[NoLv_, Lwv_,L1v_, aCCv_,epsVdWv_]:=If[NoLv==2,-epsVdWv Lwv/fSa[aCCv] L1v,0 eV/atom];*)
...
(*fScrollEnergydPhi[NoLv_, Lwv_,L1v_, RIn1v_, hv_, aCCv_, epsVdWv_, CCv_,CBNv_, dPhi12v_] := *)
(* Module[{ScrollEnergyv, EVdWv, EVdWnoDimv}, *)
(*  EVdWv = fEVdWLayersOverlap[NoLv,Lwv,L1v, RIn1v, hv, aCCv, epsVdWv,dPhi12v][[1]];*)
(*EVdWnoDimv=EVdWv/.{eV->1,atom->1,nm->1};*)
(*  If[NoLv == 1,*)
(*      If[EVdWnoDimv==0,ScrollEnergyv=fEelastCC[NoLv,Lwv,L1v, RIn1v, hv, aCCv, CCv],*)
(*         ScrollEnergyv=EVdWv +fEelastCC[NoLv,Lwv,L1v, RIn1v, hv, aCCv, CCv];];*)
(*    ];*)
(*  If[NoLv == 2,*)
(*If[EVdWnoDimv==0,*)
(*        ScrollEnergyv =fEelastCC[NoLv,Lwv,L1v, RIn1v, hv, aCCv, CCv] + *)
...
(*];*)
(**)
(*fScrollEnergyVdWandElast[NoLv_,Lwv_,L1v_, RIn1v_, hv_, aCCv_, epsVdWv_, CCv_,CBNv_] := *)
(* Module[{ ScrollEnergyVdWandElastv,EVdWv},*)
(*(*If[NoLv == 1,*)
(* EVdWv=fEVdWLayer1Overlap[NoLv,Lwv,L1v,RIn1v,hv,aCCv,epsVdWv][[1]];*)
(*];*)
(*If[NoLv == 2,*)
(* EVdWv=fEVdWLayersOverlap[NoLv,Lwv,L1v,RIn1v,hv,aCCv,epsVdWv][[1]];*)
(*];*)*)
(*EVdWv=fEVdWLayer1Overlap[NoLv,Lwv,L1v,RIn1v,hv,aCCv,epsVdWv][[1]];*)
(*If[NoLv == 1,*)
(*  ScrollEnergyVdWandElastv=EVdWv+fEelastCC[NoLv,Lwv,L1v, RIn1v, hv, aCCv, CCv];];*)
(*If[NoLv == 2,*)
(*  ScrollEnergyVdWandElastv=EVdWv+fEelastCC[NoLv,Lwv,L1v, RIn1v, hv, aCCv, CCv]+fEelastCC[NoLv,Lwv,L1v, RIn1v, hv, aCCv, CBNv];];*)
(**)
(*Return[ScrollEnergyVdWandElastv];*)
(*];*)
(**)
(*fScrollEnergy[NoLv_,Lwv_,L1v_, RIn1v_, hv_, aCCv_, epsVdWv_, CCv_,CBNv_]:=Module[*)
(*{ScrollEnergyv=-10^20 eV/atom},*)
(* If[RIn1v/m<=fRIn1Sharp[NoLv,L1v,hv]/m,*)
(*ScrollEnergyv=fScrollEnergyVdWandElast[NoLv,Lwv,L1v,RIn1v,hv,aCCv,epsVdWv,CCv,CBNv];*)
(*"note: the function fScrollEnergyVdWandElast[1,..] is analytycal";*)
(*"whereas the function fScrollEnergy[....] uses the 'If[..]'- function";*)
(*];*)
(* If[RIn1v/m>=fRIn1Sharp[NoLv,L1v,hv]/m,*)
(*If[NoLv==1,ScrollEnergyv=fEelastCC[NoLv,Lwv,L1v, RIn1v, hv, aCCv, CCv];];*)
(*If[NoLv==2,ScrollEnergyv=fEelastCC[NoLv,Lwv,L1v, RIn1v, hv, aCCv, CCv]+fEelastCC[NoLv,Lwv,L1v, RIn1v, hv, aCCv, CBNv];];*)
(**)
(*];*)
(*Return[ScrollEnergyv];*)
(*];*)
(**)
(*ScrollEnergyp=fScrollEnergy[NoLp,Lwp,L1p, RIn1p,hp, aCCp, epsVdWp,CCp,CBNp]; *)
(*ScrollEnergyp=fScrollEnergy[1,Lwp,L1p, RIn1p,hp, aCCp, epsVdWp,CCp,CBNp]; *)
(*Print["fScrollEnergy[1,Lwp,L1p, RIn1p,hp, aCCp, epsVdWp,CCp,CBNp]="];*)
(*Print["=fScrollEnergy[1, Lw=",Lwp/nm,"nm, L1=",L1p/nm,"nm, RIn1=",RIn1p/nm,"nm, h=",hp/nm,"nm,"];*)
(*Print[" aCC=", aCCp/nm,"nm, epsVdW=",epsVdWp/(eV/atom),"eV/atom, CC=",CCp/(eV AA^2/atom),"(eV AA^2/atom)="];*)
...
(*Print[" NoL=", NoLp];*)
(*Print[" epsVdW=", epsVdWp/(eV/atom),"eV/atom, C=", CCp/(eV nm^2/atom),"(eV nm^2/atom)", *)
(*  "(eV nm^2/atom),aCC=", aCCp/nm,"nm,h=", hp/nm, "nm"];*)
(*Print[" Plot ScrollEnergy[RIn1/nm]/(eV/atom) for L1=", L1p/nm, *)
(*  "nm (NoL=", NoLp, ",Lw=", Lwp/nm,"nm"];*)
(*PlotScrollEnergyVsRIn1 = Plot[(fScrollEnergy[NoLp,Lwp,L1p,RIn1nmv nm,hp, aCCp, epsVdWp, *)
(*        CCp, CBNp])/(eV/*)
...
(*  Plot[(fScrollEnergy[NoLp,Lwp,tL1[[1]], RIn1nmv nm,hp, aCCp, epsVdWp, *)
(*        CCp, CBNp] )/(eV/*)
(*        atom), {RIn1nmv, RIn1Minp/nm, RIn1Maxp/nm}, PlotRange -> PlotRangep/(eV/atom)];*)
(*PlotScrollEnergyVsRIn1L2th = *)
(*  Plot[(fScrollEnergy[NoLp,Lwp,tL1[[2]], RIn1nmv nm,hp, aCCp, epsVdWp, *)
(*        CCp, CBNp] )/(eV/*)
(*        atom), {RIn1nmv, RIn1Minp/nm, RIn1Maxp/nm}, PlotRange -> PlotRangep/(eV/atom)];*)
(*PlotScrollEnergyVsRIn1L3th = *)
(*  Plot[(fScrollEnergy[NoLp,Lwp,tL1[[3]], RIn1nmv nm,hp, aCCp, epsVdWp, *)
(*        CCp, CBNp] )/(eV/*)
(*        atom), {RIn1nmv, RIn1Minp/nm, RIn1Maxp/nm}, PlotRange -> PlotRangep/(eV/atom)];*)
(*PlotScrollEnergyVsRIn1L4th = *)
(*  Plot[(fScrollEnergy[NoLp,Lwp,tL1[[4]], RIn1nmv nm,hp, aCCp, epsVdWp, *)
(*        CCp, CBNp])/(eV/*)
(*        atom), {RIn1nmv, RIn1Minp/nm, RIn1Maxp/nm}, PlotRange -> PlotRangep/(eV/atom)];*)
...
(*Print["fScrollEnergy[NoLp,Lwp,tL1[[1]],RIn1p,hp, aCCp, epsVdWp,CCp, CBNp]=",fScrollEnergy[NoLp,Lwp,tL1[[1]],RIn1p,hp, aCCp, epsVdWp,CCp, CBNp]/(eV/atom)," eV/atom"];*)
(*Print["fScrollEnergy[NoLp,Lwp,tL1[[1]],1nm,hp, aCCp, epsVdWp,CCp, CBNp]=",fScrollEnergy[NoLp,Lwp,tL1[[1]],1nm,hp, aCCp, epsVdWp,CCp, CBNp]/(eV/atom)," eV/atom"];*)
(*Print["fScrollEnergy[NoLp,Lwp,7nm,1nm,hp, aCCp, epsVdWp,CCp, CBNp]=",fScrollEnergy[NoLp,Lwp,7.nm,1.nm,hp, aCCp, epsVdWp,CCp, CBNp]/(eV/atom)," eV/atom"];*)
(*Print["fEVdWLayer1Overlap[1,Lwp,7.nm,1.nm,hp,aCCp,epsVdWp][[1]]=",fEVdWLayer1Overlap[1,Lwp,7.nm,1.nm,hp,aCCp,epsVdWp][[1]]/(eV/atom),"eV/atom (right !=0 value, because the layer overlaps"];*)
(*Print["fEVdWLayer1Overlap[1,Lwp,7.nm,1.5nm,hp,aCCp,epsVdWp][[1]]=",fEVdWLayer1Overlap[1,Lwp,7.nm,2.5nm,hp,aCCp,epsVdWp][[1]]/(eV/atom),"eV/atom !=0, wrong value of the fEVdWLayer1Overlap[..] function because the layer does not not overlap"];*)
(*Print[];*)
...
(*Print["fScrollEnergyVdWandElast[",NoLp,",Lwv,L1v,RIn1v,hv,aCCv, epsVdWv, CCv,CBNv]:"];*)
(*Print[fScrollEnergyVdWandElast[NoLp,Lwv,L1v,RIn1v,hv,aCCv, epsVdWv, CCv,CBNv]];*)
(*Print["-----------------------------------------------------------"];*)
(**)
...
(*tRIn1nmRegular=Table[(RIn1Minp+(RIn1Maxp-RIn1Minp) iiRin/(npRIn1))/nm,{iiRin,1,npRIn1}];*)
...
(*L1pi=tL1[[iiL1]];*)
(*NanoscrollNamep=StringJoin["Nanoscroll",ToString[NoLp],"L",ToString[L1pi/nm],"nm"];*)
(*Print["NanoscrollName=",NanoscrollNamep];*)
(*ScrollEnergyFileName=StringJoin["EvsRIn1",NanoscrollNamep,".dat"];*)
(*Print["ScrollEnergyFileName=",ScrollEnergyFileName];*)
(**)
(*For[iiRIn1=1,iiRIn1<=npRIn1,iiRIn1++,*)
(*RIn1pi=tRIn1nmRegular[[iiRIn1]]nm;*)
(*tScrollEnergy[[iiRIn1]]=fScrollEnergy[NoLp,Lwp, L1pi, RIn1pi, hp, aCCp, epsVdWp, *)
(*        CCp, CBNp];*)
(**)
(*tScrollEnergyeVatom[[iiRIn1]]=(tScrollEnergy[[iiRIn1]])/(eV/atom);];*)
(*tPlotEvsRin[[iiL1]]=ListPlot[Transpose[{tRIn1nmRegular,tScrollEnergyeVatom}], PlotRange -> PlotRangep/(eV/atom)];*)
...
(*Export[ToFileName[NotebookDirectory[],ScrollEnergyFileName],Transpose[{Insert[tRIn1nmRegular,"RIn1[nm]",1],Insert[tScrollEnergyeVatom,"E[eV/atom]",1]}]]*)
(*];*)
(*Print["Plot ScrollEnergy[RIn1/nm]/(eV/atom) for L1=", tL1/nm, *)
(*  "nm (NoL=", NoLp, ",Lw=", Lwp/nm, "nm)"];*)
