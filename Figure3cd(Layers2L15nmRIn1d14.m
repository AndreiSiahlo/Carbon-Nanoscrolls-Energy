...
Print[" \:2116 3.\[LongDash] P. 036001 (9 pp.)."];
...
If[NoLp == 1,
  ...
  Print["  fSpirale1UnderSpirale1Length[NoLp,PhiIn1p,PhiOut1p,hp]=fSpirale1UnderSpirale1Length[", NoLp, ",", PhiIn1p/(2 Pi), "(2Pi),", PhiOut1p/(2 Pi),"(2Pi),", hp/nm,"nm] ="];
  Print["  =", 
...
fScrollEnergydPhi[NoLv_, Lwv_, L1v_, RIn1v_, hv_, aCCv_, epsVdWv_, 
   ...
   EVdWnoDimv = EVdWv /. {eV -> 1, atom -> 1, nm -> 1};
    ...
    If[EVdWnoDimv == 0, 
      ...
      ScrollEnergyv = 
        (EVdWv/(eV/atom) + fEelastCC[NoLv, Lwv, L1v, RIn1v, hv, aCCv, CCv]/(eV/atom))(eV/atom);];
        ];
     If[NoLv == 2,
    If[EVdWnoDimv == 0,          
      ScrollEnergyv = 
      ...
      ScrollEnergyv = 
        (EVdWv + fEelastCC[NoLv, Lwv, L1v, RIn1v, hv, aCCv, CCv]/(eV/atom) + 
                 fEelastCBN[NoLv, Lwv, L1v, RIn1v, hv, aCCv, CCv]/(eV/atom))(eV/atom);];
      ];
